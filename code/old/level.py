...
class Level:
	def __init__(self, current_level, surface, create_overworld):
		...
		# print('')
		# print(f"csv: {terrain_layout}")
		# print('')

		# self.copy_terrain_layout = terrain_layout.copy()
		# self.matrix = [list(map(int,i) ) for i in self.copy_terrain_layout]
		# for row_index, row in enumerate(self.matrix):
		# 	for col_index,val in enumerate(row):
		# 		if val == 1:
		# 			self.matrix[row_index][col_index] = 2
		# 		elif val == -1:
		...
		# print('')
		matrix = create_matrix(terrain_layout)

		# copy_matrix = self.matrix.copy()
		# exported = [list(map(int,i) ) for i in copy_matrix]
		# for row_index, row in enumerate(exported):
		# 	for col_index,val in enumerate(row):
		# 		if val == 1:
		# 			exported[row_index][col_index] = -1
		# 		elif val == 2:
		# 			exported[row_index][col_index] = 1
		# 		else:
		# 			exported[row_index][col_index] = 0
		# print(f"exported: {exported}")
		int_matrix = create_int_export(matrix)
		...
		# print('')
		# print(f"exported: {string_matrix}")
		# print('')
